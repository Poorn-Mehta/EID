# File: AWS.py (Used in AWS Lambda Function)
...
# Create SNS client using Boto
sns = boto3.client('sns', region_name='us-east-1')

# Create SQS client using Boto
...
def lambda_handler(event, context):
    ...
    if(Received_JSON['Type'] == AWS_WEB_Type_Str):
        ...
        # Handling AWS Schdule Type Message
        ...
        # Enqueue the message formatted so that the WebClient_AWS.html can understand and use it
    ...
    # Handling other types of messages
        ...
        # Sending Text & Email Notifications if message is of importance
